...
const JWT_SECRET = process.env.JWT_SECRET || 'chargemate_jwt_secret_devops_module_2025_swe7303'; 
 
const userToken = jwt.sign( 
 { id: 'testuser123', name: 'Test User', email: 'test@chargemate.com', role: 'user' }, 
 JWT_SECRET, 
 { expiresIn: '1h' } 
); 
 
const adminToken = jwt.sign( 
 { id: 'testadmin123', name: 'Test Admin', email: 'admin@chargemate.com', role: 'admin' }, 
 JWT_SECRET, 
 { expiresIn: '1h' } 
); 
 
const otherUserToken = jwt.sign( 
 { id: 'otheruser456', name: 'Other User', email: 'other@chargemate.com', role: 'user' }, 
 JWT_SECRET, 
 { expiresIn: '1h' } 
); 
